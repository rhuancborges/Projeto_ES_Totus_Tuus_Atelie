...
import ModalAlterarVenda from "../Modal/ModalAlterarVenda";
import ModalCadastrarVenda from "../Modal/ModalCadastrarVenda";

function TabelaVenda(props) {
